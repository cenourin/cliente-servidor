//Código para compilar e executar: g++ -pthread prodCons_thread_semaforo.cpp -o prodCons_thread_semaforo && ./prodCons_thread_semaforo
#include <stdio.h>
#include <pthread.h>
#include <semaphore.h>
#include <unistd.h>
